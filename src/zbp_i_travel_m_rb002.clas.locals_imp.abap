CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_rb002.
...
********************************************************************************
  ...
  METHOD get_instance_features.
    ...
    READ ENTITY zi_travel_m_rb002 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
...
********************************************************************************
  ...
  MODIFY ENTITIES OF zi_travel_m_rb002 IN LOCAL MODE
         ENTITY travel
  ...
  READ ENTITIES OF zi_travel_m_rb002 IN LOCAL MODE
       ENTITY travel
  ...
  "Get max travelID
  SELECT SINGLE FROM ztravel_rb002 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
  ...
  METHOD validateAgency.
    ...
    READ ENTITY zi_travel_m_rb002\\travel FROM VALUE #(
