CLASS zcl_generate_travel_data_rb002 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_rb002 IMPLEMENTATION.
    METHOD if_oo_adt_classrun~main.
        DATA lt_itab TYPE TABLE OF ZTRAVEL_RB002.

*       fill internal travel data table
        lt_itab = VALUE #(
...
*   delete existing entries in the database table
    DELETE FROM ztravel_rb002.

*   insert the new table entries
    INSERT ztravel_rb002 FROM TABLE @lt_itab.
